-- Runtime correction for facility tenancy RLS recursion observed in deployed databases.
-- Do not query facility_memberships directly from its own RLS policy.
