alter table public.withholding_tax
...
with claim_periods as (
  ...
  select insurance_company_id,
    ...
    count(*) filter (where is_actual = true) as withholding_tax_entry_count
...
comment on column public.withholding_tax.is_actual is
  'Whether the withholding-tax amount has been confirmed/received as an actual settlement component. False represents a provisional/calculated WHT amount.';
