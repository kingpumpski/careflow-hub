...
export default function Sidebar({ onNavigate }: { onNavigate?: () => void } = {}) {
  ...
  useEffect(() => {
    const activeGroups = NAV_GROUPS.filter(groupContaining).map((g) => g.label);
