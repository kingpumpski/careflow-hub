...
const SettlementExceptions = lazy(() => import("@/pages/SettlementExceptions"));
...
function ProtectedRoutes() {
  ...
  return <Suspense fallback={<RouteFallback />}><Routes><Route element={<AppShell />}>
    ...
    <Route path="/claims" element={<Claims />} /><Route path="/claims/settlements" element={<ClaimsSettlement />} /><Route path="/claims/settlements/exceptions" element={<SettlementExceptions />} /><Route path="/payments" element={<Payments />} /><Route path="/outstanding" element={<Outstanding />} /><Route path="/rejections" element={<Rejections />} /><Route path="/withholding-tax" element={<WithholdingTax />} />
